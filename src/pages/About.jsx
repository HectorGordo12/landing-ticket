      ...
      <div className="main">
        <div className="text">
          ...
          <div className="description">
            <p>
              <b>CONFIRMED360</b> is the leading entertainment concierge
              providing access to the world’s most coveted events. We are the
              direct source for exclusive access and the solution to the complex
              booking process.
            </p>
            <p>
          ...
          <p className={styles.yelow}>
            CLICK TO VIEW OUR EXTENDED MONTHLY EVENTS CALENDAR FOR ACCESS IN
            YOUR CITY.
          </p>
